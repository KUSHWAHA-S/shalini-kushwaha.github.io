    ...
    return (
        <>
            <section className="experience">
                <div className="ex-bg-wrap">
                    <div className="ex-bg"></div>
                ...
                <div className="container flex-col">
                    ...
                    <div className="ex-container flex-col">
                        <div className="ex-container-sub">
                            <div className="ex-box flex-col" id="ex-box-1">
                                <div className="ex-stats flex-row">
                            ...
                            <div className="ex-box flex-col" id="ex-box-2">
                                <div className="ex-stats flex-row">
                                    <div className="ex-stats-figure">8</div>
                                    <div className="ex-stats-symbol mg-1rem">+</div>
                                    <div className="ex-stats-figure mg-1rem">Successful</div>
                            ...
                            <div className="ex-box flex-col" id="ex-box-3">
                                <div className="ex-stats flex-row">
                        ...
                        <div className="ex-container-sub">
                            <div className="ex-box flex-col" id="ex-box-4">

                                <div className="ex-stats-figure mg-1rem">Software Engineer</div>
